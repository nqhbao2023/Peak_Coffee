...
const LoyaltyCard = () => {
  ...
  return (
    <div 
      className="relative bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 rounded-3xl p-6 text-white shadow-2xl overflow-hidden animate-fade-in"
    >
      {/* Background Pattern */}
      ...
      <div className="relative z-10">
        ...
        <div className="flex justify-between items-start mb-5">
          ...
          {vouchers > 0 && (
            <div 
              className="bg-white text-orange-600 px-4 py-2 rounded-full shadow-lg flex items-center gap-1.5 animate-bounce-once"
            >
        ...
        <div className="bg-white/20 backdrop-blur-sm h-2 rounded-full overflow-hidden mb-3 shadow-inner">
          <div 
            ...
            className="bg-white h-full rounded-full shadow-lg relative transition-all duration-500 ease-out"
          >
            {progress > 0 && (
